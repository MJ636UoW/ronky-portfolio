	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'THE MIND BEHIND <span class="accent-text">THE LENS</span>', 'genz-portfolio-addon' ),
			]
		);
		...
		<section class="wp-about-section">
			<div class="wp-about-grid">
				...
				<div class="wp-about-content">
					<h2 class="section-title"><?php echo wp_kses_post( $settings['title'] ); ?></h2>
