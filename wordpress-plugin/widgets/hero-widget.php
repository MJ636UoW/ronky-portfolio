	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'SHAPING <span class="accent-text">VISIONS</span> INTO ART.', 'genz-portfolio-addon' ),
			]
		);
		...
		<section class="wp-hero-section">
			...
			<div class="wp-hero-split-left">
				<div class="wp-hero-content-wrapper">
					<h1 class="wp-hero-title"><?php echo wp_kses_post( $settings['title'] ); ?></h1>
